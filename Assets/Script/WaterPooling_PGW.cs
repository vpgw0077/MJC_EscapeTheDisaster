...
public class WaterPooling_PGW : MonoBehaviour
{
    public static WaterPooling_PGW instance;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            GameObject t_object = Instantiate(WaterPrefab, transform.position, Quaternion.identity);
